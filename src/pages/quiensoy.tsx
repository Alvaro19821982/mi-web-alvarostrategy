// src/pages/quiensoy.tsx (Código completo con optimización de imagen LCP)
...
const QuienSoy = () => {
  ...
  const navigateToContact = () => {
    navigate(getPath('routes.contact'), { state: { subject: "Interesado en saber más sobre AlvaroStrategy" } });
  };
  ...
  const schemaMarkup = {
    ...
    "mainEntity": {
      ...
      "jobTitle": t('whoAmI.jobTitle'),
      "worksFor": { "@type": "Organization", "name": "AlvaroStrategy" },
      "description": t('whoAmI.meta_description'),
      "alumniOf": [{ "@type": "EducationalOrganization", "name": "BigSchool", "sameAs": "https://thebigschool.com/" }],
      "knowsAbout": ["SEO", "Inteligencia Artificial", "Estrategia Digital", "Marketing de Contenidos", "CRO", "Analítica Web", "Growth Hacking"],
      "sameAs": ["https://www.linkedin.com/in/alvarofernandezdecelis/"]
    },
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": t('nav.home'), "item": `https://alvarostrategy.com/${currentLang}` },
        { "@type": "ListItem", "position": 2, "name": t('whoAmI.breadcrumb') }
      ]
    }
  };
        ...
        >
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="mb-8 md:mb-10">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage className="text-sm font-medium text-gray-700 dark:text-slate-200">{t('whoAmI.breadcrumb')}</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </motion.div>
          ...
          <motion.header variants={fadeInUp} className="text-center mb-10 md:mb-12 lg:mb-16">
            <Badge className="mb-5 sm:mb-6 bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base font-semibold rounded-lg shadow-xl cursor-default">
              <UserCircle className="w-5 h-5 mr-2 inline-block" /> {t('whoAmI.badge')}
            </Badge>
            <h1 className="text-4xl sm:text-5xl md:text-[3.25rem] lg:text-6xl font-black bg-gradient-to-r from-gray-900 via-blue-800 to-indigo-800 dark:from-slate-100 dark:via-blue-400 dark:to-indigo-400 bg-clip-text text-transparent leading-tight">
              <Trans i18nKey="whoAmI.title">
                Detrás de la estrategia, <span className="whitespace-nowrap">hay un profesional</span>
              </Trans>
            </h1>
          </motion.header>

          <motion.section variants={fadeInUp} className="bg-white dark:bg-slate-800/70 p-6 sm:p-8 lg:p-10 rounded-2xl shadow-xl border-t-4 border-blue-500 dark:border-blue-400 mb-12 md:mb-16">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 mb-6 sm:mb-8">
              <Avatar className="w-32 h-32 sm:w-40 sm:h-40 border-4 border-blue-500/50 dark:border-blue-400/50 shadow-lg">
                {/* MODIFICACIÓN: Añadido fetchpriority="high" a la imagen LCP. */}
                <AvatarImage src="/images/Alvaro%20Fernandez%20de%20Celis.webp" alt="Álvaro Fernández de Celis - Consultor SEO e IA" fetchPriority="high" />
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-md sm:text-lg text-blue-600 dark:text-blue-400 font-semibold mb-3">{t('whoAmI.jobTitle')}</p>
                <Button asChild variant="outline" className="border-blue-500 text-blue-600 hover:bg-blue-500 hover:text-white dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-400 dark:hover:text-slate-900 group">
                  <a href="https://www.linkedin.com/in/alvarofernandezdecelis/" target="_blank" rel="noopener noreferrer nofollow" aria-label="Perfil de LinkedIn de Álvaro Fernández de Celis">
                    <Linkedin className="w-4 h-4 mr-2" /> {t('whoAmI.linkedinButton')} <ExternalLink className="w-3 h-3 ml-1.5 opacity-70 group-hover:opacity-100" />
                  </a>
                </Button>
              </div>
            </div>
            ...
            <div className="prose prose-base sm:prose-lg max-w-none dark:prose-invert prose-p:mb-5 prose-p:leading-relaxed prose-strong:text-blue-600 dark:prose-strong:text-blue-400">
              <p>{t('whoAmI.intro_p1')}</p>
              <p>
                <Trans i18nKey="whoAmI.intro_p2">
          ...
          <motion.section variants={fadeInUp} className="bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 dark:from-blue-700 dark:via-indigo-800 dark:to-purple-900 p-6 sm:p-8 lg:p-10 rounded-2xl shadow-xl text-white mb-12 md:mb-16">
            <div className="text-center mb-8 sm:mb-10">
              <h2 className="text-2xl sm:text-3xl font-bold flex flex-col sm:flex-row items-center justify-center">
                ...
                <span>{t('whoAmI.education_title')}</span>
              </h2>
              <p className="text-lg sm:text-xl text-blue-200/90 dark:text-blue-300/90 mt-1 sm:mt-2 font-medium">{t('whoAmI.education_subtitle')}</p>
            </div>
            ...
            <p className="text-md sm:text-lg mb-8 leading-relaxed text-blue-100/90 dark:text-blue-200/90 prose prose-invert max-w-none prose-strong:text-white">
                <Trans i18nKey="whoAmI.education_intro">
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-8">
              <Card className="bg-white/10 dark:bg-white/5 p-5 sm:p-6 rounded-xl backdrop-blur-md border border-white/20 shadow-lg hover:bg-white/20 dark:hover:bg-white/10 transition-colors duration-300 flex flex-col">
                <CardHeader className="p-0 mb-4">
                  <div className="flex items-center mb-3">
                    <div className="p-2 bg-blue-400/50 rounded-full mr-3 ring-1 ring-blue-300/70"><Award className="w-6 h-6 sm:w-7 sm:h-7 text-white" /></div>
                    <CardTitle className="text-xl sm:text-2xl font-semibold text-white">{t('whoAmI.seo_master_title')}</CardTitle>
                  </div>
                  <CardDescription className="text-sm text-blue-200/80 dark:text-blue-300/80">{t('whoAmI.seo_master_school')}</CardDescription>
                </CardHeader>
                <CardContent className="p-0 text-sm sm:text-base text-blue-100/90 dark:text-blue-200/90 leading-relaxed flex-grow flex flex-col">
                  <p className="mb-3">{t('whoAmI.seo_master_desc')}</p>
                  <div className="mt-auto"><img src="/images/Titulo%20de%20Master%20de%20SEO%20de%20BigSchool%20Alvaro%20Fernandez%20de%20Celis.webp" alt="Título Máster SEO Alvaro Fernández de Celis" className="rounded-md shadow-md border border-blue-300/30 max-h-60 object-contain mx-auto mb-3" loading="lazy" width="300" height="212"/></div>
                </CardContent>
                <CardFooter className="p-0 mt-auto pt-4">
                  <Button asChild variant="outline" className="w-full bg-white/10 hover:bg-white/20 text-white border-white/30 hover:border-white/50 group">
                    <a href="https://credsverse.com/credentials/490463f5-50ba-4e64-8f46-0cb92d1325a2" target="_blank" rel="noopener noreferrer nofollow" aria-label="Ver credencial del Máster en SEO en Credsverse">
                      {t('whoAmI.credential_button')} <ExternalLink className="w-3.5 h-3.5 ml-1.5 opacity-80 group-hover:opacity-100"/>
                    </a>
                  </Button>
                </CardFooter>
              </Card>
              ...
              <Card className="bg-white/10 dark:bg-white/5 p-5 sm:p-6 rounded-xl backdrop-blur-md border border-white/20 shadow-lg hover:bg-white/20 dark:hover:bg-white/10 transition-colors duration-300 flex flex-col">
                <CardHeader className="p-0 mb-4">
                  <div className="flex items-center mb-3">
                    <div className="p-2 bg-indigo-400/50 rounded-full mr-3 ring-1 ring-indigo-300/70"><Brain className="w-6 h-6 sm:w-7 sm:h-7 text-white" /></div>
                    <CardTitle className="text-xl sm:text-2xl font-semibold text-white">{t('whoAmI.ia_master_title')}</CardTitle>
                  </div>
                  <CardDescription className="text-sm text-blue-200/80 dark:text-blue-300/80">{t('whoAmI.ia_master_school')}</CardDescription>
                </CardHeader>
                <CardContent className="p-0 text-sm sm:text-base text-blue-100/90 dark:text-blue-200/90 leading-relaxed flex-grow flex flex-col">
                  <p className="mb-3">{t('whoAmI.ia_master_desc')}</p>
                  <div className="mt-auto"><img src="/images/Titulo%20de%20Master%20de%20IA%20de%20BigSchool%20Alvaro%20Fernandez%20de%20Celis.webp" alt="Título Máster IA Alvaro Fernández de Celis" className="rounded-md shadow-md border border-indigo-300/30 max-h-60 object-contain mx-auto mb-3" loading="lazy" width="300" height="212"/></div>
                </CardContent>
                <CardFooter className="p-0 mt-auto pt-4">
                  <Button asChild variant="outline" className="w-full bg-white/10 hover:bg-white/20 text-white border-white/30 hover:border-white/50 group">
            ...
            <p className="text-md sm:text-lg text-center leading-relaxed text-blue-100/90 dark:text-blue-200/90 prose prose-invert max-w-none prose-strong:text-white">
                <Trans i18nKey="whoAmI.education_outro">
          ...
          <motion.section variants={fadeInUp} className="text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-700 dark:text-slate-100 mb-6">{t('whoAmI.cta_title')}</h2>
            <p className="text-md sm:text-lg text-gray-600 dark:text-slate-300 mb-8 leading-relaxed max-w-2xl mx-auto">{t('whoAmI.cta_desc')}</p>
            <Button
              size="lg"
            ...
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-4 italic">{t('whoAmI.cta_note')}</p>
          </motion.section>
        </motion.div>
      </div>
    </>
